...
#  Mexilhoeira Grande, Dom Jul 30 11:40:50 WEST 2017
#  Written by Tordar
#  
#==================================================================

# ipython: run DickinsCervenyB
...
fid = open('DickinsCervenyB.bty','r')
...
system("bellhop.exe DickinsCervenyB")

filename = 'DickinsCervenyB.shd'
xs = nan
ys = nan

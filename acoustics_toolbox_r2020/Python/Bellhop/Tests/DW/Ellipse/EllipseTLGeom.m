...
system('bellhop.exe EllipseTLGeom');

[ PlotTitle, PlotType, freq, atten, Pos, p ] = read_shd( 'EllipseTLGeom.shd' );
...
hold off
axis([0 rmaxkm zmin zmax])
view(0,-90)
xlabel('Range (km)')
ylabel('Depth (m)')
title('Bellhop - Ellipse, 10 Hz')

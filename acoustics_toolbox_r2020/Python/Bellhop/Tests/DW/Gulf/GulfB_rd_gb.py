#==================================================================
#  
#  Bellhop: Topgulf, Range dep., Gaussian beams 
#  Mexilhoeira Grande, Dom Jul 30 14:49:42 WEST 2017
#  Written by Tordar
#  
#==================================================================

# ipython: run GulfB_rd_gb
...
xlabel('Range (km)')
ylabel('Depth (m)')
title('Bellhop - Topgulf, Range dep., Gaussian beams')
xlim(0,rmaxkm)
ylim(Dmax,0)

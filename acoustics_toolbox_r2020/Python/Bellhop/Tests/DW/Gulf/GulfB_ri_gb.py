#==================================================================
#  
#  Bellhop: Topgulf, Range ind., Gaussian beams  
#  Mexilhoeira Grande, Dom Jul 30 14:34:43 WEST 2017
#  Written by Tordar
#  
#==================================================================

# ipython: run GulfB_ri_gb
...
print("Bellhop - Topgulf, Range ind., Gaussian beams:")
print("Coherent TL calculation")
print("Geometric gaussian beams")

system("bellhop.exe GulfB_ri_gb")

filename = 'GulfB_ri_gb.shd'
xs = nan
ys = nan

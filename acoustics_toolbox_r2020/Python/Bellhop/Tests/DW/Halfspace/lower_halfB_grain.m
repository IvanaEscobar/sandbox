...
disp('Bellhop - Halfspace:') 
disp('TL calculation') 

system('bellhop.exe lower_halfB_grain');

[ PlotTitle, PlotType, freq, atten, Pos, p ] = read_shd( 'lower_halfB_grain.shd' );

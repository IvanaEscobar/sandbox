#==================================================================
#  
#  Bellhop: Free space, line source, Gaussian beam
#  Mexilhoeira Grande, Dom Jul 30 16:33:05 WEST 2017
#  Written by Tordar
#  
#==================================================================

# ipython: run freeLine_gbtB
...
print("Bellhop - Free space, line source, Gaussian beam:")
print("Coherent TL calculation")
print("Geometric gaussian beams")

system("bellhop.exe freeLine_gbtB")

filename = 'freeLine_gbtB.shd'
xs = nan
ys = nan
...
xlabel('Range (km)')
ylabel('Depth (m)')
title('Bellhop - Free space, line source, Gaussian beam')
xlim(0,rmaxkm)
ylim(Dmax,0)

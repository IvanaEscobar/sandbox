...
disp('Bellhop - Lloyd mirror') 

system('bellhop.exe LloydPoint_gbtB');

[ PlotTitle, PlotType, freq, atten, Pos, p ] = read_shd( 'LloydPoint_gbtB.shd' );
...
xlabel('Range (km)')
ylabel('Depth (m)')
title('Bellhop - Lloyd mirror, 5 kHz')

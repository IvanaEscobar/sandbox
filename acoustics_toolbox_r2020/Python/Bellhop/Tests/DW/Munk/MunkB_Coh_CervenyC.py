#==================================================================
#  
#  Bellhop: Munk profile, CervenyC-style beams, IBWin=5
#  Mexilhoeira Grande, Dom Jul 30 16:47:45 WEST 2017
#  Written by Tordar
#  
#==================================================================

# ipython: run MunkB_Coh_CervenyC
...
system("bellhop.exe MunkB_Coh_CervenyC")

filename = 'MunkB_Coh_CervenyC.shd'
xs = nan
ys = nan
...
xlabel('Range (km)')
ylabel('Depth (m)')
title('Bellhop - Munk profile, CervenyC-style beams')
ylim(Dmax,0)

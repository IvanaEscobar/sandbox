#==================================================================
#  
#  Bellhop: Munk profile, CervenyR-style beams, IBWin=5
#  Mexilhoeira Grande, Dom Jul 30 16:52:41 WEST 2017
#  Written by Tordar
#  
#==================================================================

# ipython: run MunkB_Coh_CervenyR
...
system("bellhop.exe MunkB_Coh_CervenyR")

filename = 'MunkB_Coh_CervenyR.shd'
xs = nan
ys = nan
...
xlabel('Range (km)')
ylabel('Depth (m)')
title('Bellhop - Munk profile, CervenyR-style beams')
ylim(Dmax,0)

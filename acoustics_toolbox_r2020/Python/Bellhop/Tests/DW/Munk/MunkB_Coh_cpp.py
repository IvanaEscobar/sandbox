#==================================================================
#  
#  Bellhop: Munk profile, Cerveny-style beams, IBWin=5
#  Mexilhoeira Grande, Dom Jul 30 16:55:43 WEST 2017
#  Written by Tordar
#  
#==================================================================

# ipython: run MunkB_Coh_cpp
...
system("bellhop.exe MunkB_Coh_cpp")

filename = 'MunkB_Coh_cpp.shd'
xs = nan
ys = nan
...
xlabel('Range (km)')
ylabel('Depth (m)')
title('Bellhop - Munk profile, Cerveny-style beams')
ylim(Dmax,0)

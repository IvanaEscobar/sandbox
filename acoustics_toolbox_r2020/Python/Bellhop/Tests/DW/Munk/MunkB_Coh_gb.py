#==================================================================
#  
#  Bellhop: Munk profile, coherent, Gaussian beam
#  Mexilhoeira Grande, Dom Jul 30 16:57:42 WEST 2017
#  Written by Tordar
#  
#==================================================================

# ipython: run MunkB_Coh_gb
...
system("bellhop.exe MunkB_Coh_gb")

filename = 'MunkB_Coh_gb.shd'
xs = nan
ys = nan
...
xlabel('Range (km)')
ylabel('Depth (m)')
title('Bellhop - Munk profile, coherent, Gaussian beam')
ylim(Dmax,0)

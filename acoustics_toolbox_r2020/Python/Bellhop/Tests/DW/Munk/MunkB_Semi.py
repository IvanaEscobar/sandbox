#==================================================================
#  
#  Bellhop: Munk profile, semi-coherent
#  Mexilhoeira Grande, Dom Jul 30 19:22:41 WEST 2017
#  Written by Tordar
#  
#==================================================================

# ipython: run MunkB_Semi
...
print("Munk profile, semi-coherent:") 
print("Semi-coherent TL calculation")
print("Geometric hat beams in Cartesian coordinates")

system("bellhop.exe MunkB_Semi")

filename = 'MunkB_Semi.shd'
xs = nan
ys = nan
...
xlabel('Range (km)')
ylabel('Depth (m)')
title('Munk profile, semi-coherent')
ylim(Dmax,0)

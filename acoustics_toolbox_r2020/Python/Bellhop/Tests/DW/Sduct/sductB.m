...
disp('Bellhop - Leaky surface duct:') 
disp('TL calculation')

system('bellhop.exe sductB');

[ PlotTitle, PlotType, freq, atten, Pos, p ] = read_shd( 'sductB.shd' );
...
xlabel('Range (km)')
ylabel('Depth (m)')
title('Bellhop - Leaky surface duct, 200 Hz')

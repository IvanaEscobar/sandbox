#==================================================================
#  
#  Bellhop: Free space, point source, Inc.
#  Mexilhoeira Grande, Dom Jul 30 20:10:47 WEST 2017
#  Written by Tordar
#  
#==================================================================

# ipython: run freePointB_Inc
...
print("Bellhop - Free space, point source, Inc.:") 
print("Incoherent TL calculation")
print("Geometric hat beams in Cartesian coordinates")

system("bellhop.exe freePointB_Inc")

filename = 'freePointB_Inc.shd'
xs = nan
ys = nan
...
xlabel('Range (km)')
ylabel('Depth (m)')
title('Bellhop - Free space, point source, Inc.')
ylim(Dmax,0)

#==================================================================
#  
#  Bellhop: Free space, point source, Gaussian beam, Inc.
#  Mexilhoeira Grande, Dom Jul 30 20:14:49 WEST 2017
#  Written by Tordar
#  
#==================================================================

# ipython: run freePoint_gbtB_Inc
...
system("bellhop.exe freePoint_gbtB_Inc")

filename = 'freePoint_gbtB_Inc.shd'
xs = nan
ys = nan
...
xlabel('Range (km)')
ylabel('Depth (m)')
title('Bellhop - Free space, point source, Gaussian beam, Inc.')
ylim(Dmax,0)

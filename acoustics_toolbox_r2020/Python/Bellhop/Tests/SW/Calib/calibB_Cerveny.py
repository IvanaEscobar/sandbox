#==================================================================
#  
#  Bellhop: Calibration case, Cerveny Gaussian beams 
#  Mexilhoeira Grande, Dom Jul 30 21:06:04 WEST 2017
#  Written by Tordar
#  
#==================================================================

# ipython: run calibB_Cerveny
...
print("Bellhop - Calibration case, Cerveny Gaussian beams:") 
print("Coherent TL calculation")
print("Cartesian beams")

system("bellhop.exe calibB_Cerveny")

filename = 'calibB_Cerveny.shd'
xs = nan
ys = nan
...
xlabel('Range (km)')
ylabel('Depth (m)')
title('Bellhop - Calibration case, Cerveny Gaussian beams')
ylim(Dmax,0)

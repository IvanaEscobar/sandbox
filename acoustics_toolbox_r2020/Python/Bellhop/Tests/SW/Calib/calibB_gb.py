...
#  Mexilhoeira Grande, Dom Jul 30 21:08:32 WEST 2017
#  Written by Tordar
#  
#==================================================================

# ipython: run calibB_gb
...
system("bellhop.exe calibB_gb")

filename = 'calibB_gb.shd'
xs = nan
ys = nan
...
xlabel('Range (km)')
ylabel('Depth (m)')
title('Bellhop - Calibration case, Gaussian beams')
ylim(Dmax,0)

...
!--------------------- interface arguments -----------------------------
   ...
   _RL , intent(out), dimension(:,:)   :: rain,snow
   _RL , intent(out), dimension(:,:,:) :: tdel, qdel, qsat
...
logical,dimension(size(tin,1),size(tin,2),size(tin,3)) :: do_adjust
   _RL,dimension(size(tin,1),size(tin,2),size(tin,3)) ::  &
                             esat, desat, dqsat, pmes, pmass
   _RL,dimension(size(tin,1),size(tin,2))             :: hlcp, precip
integer  k, kx
!-----------------------------------------------------------------------
...
!-----------------------------------------------------------------------
   _RL, intent(in),    dimension(:,:,:) :: pmass, dqsat
   _RL, intent(in),    dimension(:,:,:) :: tin, qin, qsat
   _RL, intent(in),    dimension(:,:)   :: hlcp
   _RL, intent(inout), dimension(:,:,:) :: tdel, qdel
   integer, intent(in)                   :: myThid
   _RL, intent(in), dimension(:,:,:), optional :: mask
!-----------------------------------------------------------------------
   _RL, dimension(size(tin,1),size(tin,2)) :: exq, def

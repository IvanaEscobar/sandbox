...
_RL, intent(in)                  :: Time_diag
_RL, intent(in) , dimension(:,:)   :: lat
_RL, intent(out), dimension(:,:)   :: net_surf_sw_down
_RL, intent(out), dimension(:,:)   :: surf_lw_down
_RL, intent(in) , dimension(:,:,:) :: t, q
_RL, intent(in) , dimension(:,:,:) :: p_half
_RL, intent(in) , dimension(:,:)   :: albedo
_RL, intent(in) , dimension(:,:,:) :: o3conc
_RL, intent(out), dimension(:,:,:) :: ozone_column
_RL, intent(out), dimension(:,:,:) :: dtrans
_RL, intent(out), dimension(:,:,:) :: dtrans_win
_RL, intent(out), dimension(:,:,:) :: b
_RL, intent(out), dimension(:,:,:) :: b_win
_RL, intent(out), dimension(:,:,:) :: down
_RL, intent(out), dimension(:,:,:) :: solar_down
integer, intent(in)                 :: myThid
...
_RL, allocatable, dimension(:,:)   :: ss, solar, solar_tau_0, p2
_RL, allocatable, dimension(:,:)   :: solar_tau_k, sw_wv, del_sol_tau, mag_fac
_RL, allocatable, dimension(:,:,:) :: solar_tau, dtrans_sol, down_win
_RL, allocatable, dimension(:,:)   :: del_tau, tau_0, tau_km, tau_kp, del_tau_win
! MK: Variables for Lacis & Hansen ozone SW scheme
_RL, allocatable, dimension(:,:,:) :: ozone_mag, ozone_dF0_down
_RL, allocatable, dimension(:,:)   :: abs_uv_LH, abs_uv_LH_FS
_RL, allocatable, dimension(:,:)   :: abs_vis_LH, abs_vis_LH_FS
! Variables for seasonal Incoming SW
_RL, allocatable, dimension(:,:)   :: cLat, sLat, cos_H, HourAng
! -------------------------------------------------------------------------
...
_RL, intent(in)                    :: Time_diag
_RL, intent(in) , dimension(:,:)   :: lat
_RL, intent(in) , dimension(:,:)   :: t_surf
_RL, intent(in) , dimension(:,:,:) :: t, p_half
_RL, intent(inout), dimension(:,:,:) :: tdt
_RL, intent(out), dimension(:,:,:) :: flux_lw
_RL, intent(out), dimension(:,:,:) :: flux_sw
_RL, intent(in),  dimension(:,:)   :: albedo
_RL, intent(in) , dimension(:,:,:) :: ozone_column
_RL, intent(in),  dimension(:,:,:) :: dtrans
_RL, intent(in),  dimension(:,:,:) :: dtrans_win
_RL, intent(in),  dimension(:,:,:) :: b
_RL, intent(in),  dimension(:,:,:) :: b_win
_RL, intent(in),  dimension(:,:,:) :: down
_RL, intent(in),  dimension(:,:,:) :: solar_down
integer, intent(in)                 :: myThid
...
! -------------------------------------------------------------------------
_RL, allocatable, dimension(:,:)   :: solar, b_surf
_RL, allocatable, dimension(:,:,:) :: tdt_rad, up, up_win, solar_up
!real, allocatable, dimension(:,:,:) :: tdt_sw, flux_rad   ! not used
! MK: Variables for Lacis & Hansen ozone SW scheme
_RL, allocatable, dimension(:,:,:) :: ozone_mag_up, ozone_dF0_up
_RL, allocatable, dimension(:,:)   :: abs_uv_LH_up, abs_uv_LH_FS_up
_RL, allocatable, dimension(:,:)   :: abs_vis_LH_up, abs_vis_LH_FS_up
_RL, allocatable, dimension(:,:)   :: r_bar
! -------------------------------------------------------------------------

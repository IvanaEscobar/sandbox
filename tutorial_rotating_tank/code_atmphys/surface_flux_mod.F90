...
! ============================================================================
  ...
  _RL, intent(out), dimension(:) :: &
       u_star,     b_star
  _RL, intent(inout), dimension(:) :: q_surf
  _RL, intent(in) :: dt
  integer, intent(in) :: myThid

  ! ---- local constants -----------------------------------------------------
  ! temperature increment and its reciprocal value for comp. of derivatives
  _RL, parameter:: del_temp=0.1, del_temp_inv=1.0/del_temp

  ! ---- local vars ----------------------------------------------------------
  _RL, dimension(size(t_atm)) ::                          &
...
subroutine surface_flux_0d (                                                 &
  ...
  _RL, intent(out) :: &
       ...
       w_atm_0,     q_star_0,             &
       cd_m_0,      cd_t_0,       cd_q_0
  _RL, intent(out) :: u_star_0,  b_star_0
  _RL, intent(inout) :: q_surf_0
  _RL, intent(in)    :: dt
  integer, intent(in) :: myThid
  ...
  _RL, dimension(1) :: &
       ...
       w_atm,     q_star,             &
       cd_m,      cd_t,       cd_q
  _RL, dimension(1) :: u_star, b_star
  _RL, dimension(1) :: q_surf
...
subroutine surface_flux_2d (                                           &
  ...
  _RL, intent(out), dimension(:,:) :: &
       ...
       w_atm,     q_star,             &
       cd_m,      cd_t,       cd_q
  _RL, intent(out), dimension(:,:) :: u_star,     b_star
  _RL, intent(inout), dimension(:,:) :: q_surf
  _RL, intent(in) :: dt
  integer, intent (in) :: myThid
